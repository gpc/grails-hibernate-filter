...
public class HibernateFilterBuilder {
    ...
    private void addFilter(String name, Map options) {
        ...
        def entity = options.collection ? configuration.getCollectionMapping("${domainClass.fullName}.${options.collection}") : configuration.getClassMapping(domainClass.fullName)
